...
contract('PaymentProcessor', async (accounts) => {
    ...
    describe('payments', function () {
        ...
        it('should let a third party mediate transfers between merchants and buyers with no ETH', async function () {
            ...
            await paymentProcessor.processPaymentThirdPartyPaysForGas(merchantAddress, SUPPLY.div(10).toString(), timestamp, [signatureBuyer.v.toString(), signatureMerchant.v.toString()], ['0x' + signatureBuyer.r.toString('hex'), '0x' + signatureBuyer.s.toString('hex'), '0x' + signatureMerchant.r.toString('hex'), '0x' + signatureMerchant.s.toString('hex')], 0, '0x0000000000000000000000000000000000000000', buyerAddress,
                {from: accounts[1]})
